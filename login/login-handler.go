...
func LoginHandler(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		json.NewEncoder(w).Encode(&models.APIResponse{Code: 400, Message: "invalid request payload", Details: err.Error()})
		return
	}
	fmt.Println("22222")
	...
	if err != nil {
		json.NewEncoder(w).Encode(&models.APIResponse{Code: 400, Message: "database connection failed", Details: err.Error()})
		return
	}
	fmt.Println("333333")
	...
	user, err := helpers.GetUserByUserEmail(u.Email, u.Password, db)
	...
	if err != nil {
		json.NewEncoder(w).Encode(&models.APIResponse{Code: 400, Message: "server error", Details: err.Error()})
		return
	}
	fmt.Println("5555555")
